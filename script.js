...
// ここは以前の Mixed Content エラーが発生していた部分ですが、
// 一旦「表示されていた時」のコードに戻します。
// 問題が解決したら、HTTPSへの修正を再度検討します。
tag.src = "https://www.youtube.com/iframe_api"; // ★この行に注意★
